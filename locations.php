...
while($data = mysqli_fetch_assoc($location)){
 ...
 <div class="location-detail" id="<?php echo $data["loc_name"]; ?>">
    ...
    <a href="<?php echo $data['vr']; ?>" class="button">Virtual view</a>
    <?php
    if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) 
    {
        echo "<span><a href='./booking.php' class='button' id='Raigad'>Book Now</a></span>";
    }?>    
    <!-- <span><a href="./booking.php" class="button" id="Raigad">Book Now</a></span> -->
 </div>
